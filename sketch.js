console.log("Ballon Buster 1 by Nikhil.")
...
var select_balloon = Math.round(random(1,4));
 ...
 function createArrow() {
  ...
  if(arrow.x === red.x &&  arrow.y === red.y ){
    red.velocityX = 0
    text("Game over! ",score,200,200)
  }
  if(arrow.x === green.x && arrow.y === green.y){
    green.velocityX = 0
    text("Game over! ",score,200,200)
  }
  if(arrow.x === blue.x && arrow.y == blue.y){
    blue.velocityX = 0
    text("Game over! ",score,200,200)
  }
  if(arrow.x === pink.x && arrow.y === pink.y){
    pink.velocityX = 0
    text("Game over! ",score,200,200)
  }
